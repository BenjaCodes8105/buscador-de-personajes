...
// Mostrar mensajes de error o avisos
function mostrarMensaje(icono, texto, subtexto = "") {
    // CORRECCIÓN: El operador ternario ahora devuelve un String de HTML correcto entre comillas
    resultado.innerHTML = `
        <div class="msg-box">
...
boton.addEventListener("click", () => {
    ...
    // CORRECCIÓN: Se agregó un emoji o icono vacío para respetar los parámetros de la función
    if (valor === "") {
        mostrarMensaje("⚠️", "Por favor, ingresá un nombre o un ID");
        return;
    }

    // Búsqueda por NOMBRE (texto)
    if (isNaN(valor)) {
        // CORRECCIÓN: Se envolvieron las URLs en comillas invertidas ``
